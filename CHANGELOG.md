...
**Project name:** This repository is now **Skein** (`com.skein.android`), rebranded from the open-source bitchat-android mesh client. Entries below retain historical version notes from that lineage; they are not a claim of separate Skein-only release history for every past tag.
...
### Changed
- Rebrand documentation and public metadata to **Skein** (applicationId `com.skein.android`)
...
### Added
- Initial Android implementation of the mesh protocol (historical bitchat-android lineage)
...
### Added
- Initial release of the Android mesh client (historical bitchat-android lineage)
- Basic mesh networking functionality
- Core messaging features
- Cross-platform protocol compatibility notes from that era
