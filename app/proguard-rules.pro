...
-keep class com.skein.android.protocol.** { *; }
-keep class com.skein.android.crypto.** { *; }
-dontwarn org.bouncycastle.**
-keep class org.bouncycastle.** { *; }

# Keep SecureIdentityStateManager from being obfuscated to prevent reflection issues
-keep class com.skein.android.identity.SecureIdentityStateManager {
    private android.content.SharedPreferences prefs;
    *;
}

# Keep all classes that might use reflection
-keep class com.skein.android.favorites.** { *; }
-keep class com.skein.android.nostr.** { *; }
-keep class com.skein.android.identity.** { *; }

# Keep Tor implementation (always included)
-keep class com.skein.android.net.RealTorProvider { *; }
