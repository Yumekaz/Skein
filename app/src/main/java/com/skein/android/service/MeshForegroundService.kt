package com.skein.android.service
...
import com.skein.android.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "skein_mesh_service"
        private const val NOTIFICATION_ID = 10001

        const val ACTION_START = "com.skein.android.service.START"
        const val ACTION_STOP = "com.skein.android.service.STOP"
        const val ACTION_QUIT = "com.skein.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.skein.android.service.UPDATE_NOTIFICATION"
        const val ACTION_NOTIFICATION_PERMISSION_GRANTED = "com.skein.android.action.NOTIFICATION_PERMISSION_GRANTED"
    ...
    private val unifiedMeshService: com.skein.android.mesh.MeshService?
    ...
    private fun ensureMeshStarted() {
        ...
        val bleEnabled = try {
            com.skein.android.ui.debug.DebugPreferenceManager.getBleEnabled(true)
        } catch (_: Exception) {
            true
        }
        if (!bleEnabled) {
    ...
    private fun buildNotification(activePeers: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                ...
                getString(R.string.notification_action_quit_skein),
                quitPendingIntent
            )
            .build()
    }
