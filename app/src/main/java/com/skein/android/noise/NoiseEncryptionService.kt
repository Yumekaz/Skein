package com.skein.android.noise
...
import com.skein.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.skein.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.skein.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.skein.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a SkeinPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.skein.android.protocol.SkeinPacket): com.skein.android.protocol.SkeinPacket? {
    ...
    /**
     * Verify a SkeinPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.skein.android.protocol.SkeinPacket, publicKey: ByteArray): Boolean {
