...
import com.skein.android.favorites.FavoritesPersistenceService
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.asStateFlow
import com.skein.android.mesh.BluetoothMeshDelegate
import com.skein.android.mesh.BluetoothMeshService
...
import com.skein.android.util.NotificationIntervalManager
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.util.Date
import kotlin.random.Random
import com.skein.android.services.VerificationService
import com.skein.android.identity.SecureIdentityStateManager
import com.skein.android.noise.NoiseSession
import com.skein.android.nostr.GeohashAliasRegistry
import com.skein.android.util.dataFromHexString
import com.skein.android.util.hexEncodedString
import java.security.MessageDigest

/**
 * Refactored ChatViewModel - Main coordinator for Skein functionality
...
class ChatViewModel(
    ...
    val messages: StateFlow<List<SkeinMessage>> = state.messages
    ...
    val privateChats: StateFlow<Map<String, List<SkeinMessage>>> = state.privateChats
    ...
    val channelMessages: StateFlow<Map<String, List<SkeinMessage>>> = state.channelMessages
    ...
    val selectedLocationChannel: StateFlow<com.skein.android.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    fun getMeshPeerInfo(peerID: String): com.skein.android.mesh.PeerInfo? = mesh.getPeerInfo(peerID)
    ...
    init {
        ...
        viewModelScope.launch {
            try { com.skein.android.services.AppStateStore.peers.collect { peers ->
                state.setConnectedPeers(peers)
                state.setIsConnected(peers.isNotEmpty())
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.skein.android.services.AppStateStore.publicMessages.collect { msgs ->
                // Source of truth is AppStateStore; replace to avoid duplicate keys in LazyColumn
                state.setMessages(msgs)
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.skein.android.services.AppStateStore.privateMessages.collect { byPeer ->
                ...
                try {
                    val seen = com.skein.android.services.SeenMessageStore.getInstance(getApplication())
        ...
        viewModelScope.launch {
            try { com.skein.android.services.AppStateStore.channelMessages.collect { byChannel ->
                // Replace with store snapshot
        ...
        viewModelScope.launch {
            com.skein.android.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.skein.android.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.skein.android.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.skein.android.geohash.ChannelID.Mesh) {
        ...
        com.skein.android.favorites.FavoritesPersistenceService.initialize(getApplication())
        ...
        try {
            val nostrTransport = com.skein.android.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.skein.android.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.skein.android.nostr.NostrSubscriptionManager
                val identity = com.skein.android.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.skein.android.nostr.NostrDirectMessageHandler
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.skein.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.skein.android.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.skein.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, mesh, mesh.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.skein.android.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.skein.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.skein.android.services.MessageRouter.getInstance(getApplication(), mesh)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.skein.android.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.skein.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.skein.android.identity.SecureIdentityStateManager(getApplication())
                ...
                com.skein.android.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    com.skein.android.services.MessageRouter
    ...
    override fun didReceiveMessage(message: SkeinMessage) {
    ...
    fun panicClearAllData() {
        ...
        try {
            com.skein.android.services.SeenMessageStore.getInstance(getApplication()).clear()
        } catch (_: Exception) { }
        ...
        com.skein.android.features.file.FileUtils.clearAllMedia(getApplication())
        ...
        try {
            ...
            try {
                val store = com.skein.android.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }

            try {
                val locationManager = com.skein.android.geohash.LocationChannelManager.getInstance(getApplication())
    ...
    fun selectLocationChannel(channel: com.skein.android.geohash.ChannelID) {
