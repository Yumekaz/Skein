...
import com.skein.android.nostr.GeohashMessageHandler
import com.skein.android.nostr.GeohashRepository
import com.skein.android.nostr.NostrDirectMessageHandler
import com.skein.android.nostr.NostrIdentityBridge
import com.skein.android.nostr.NostrProtocol
import com.skein.android.nostr.NostrRelayManager
import com.skein.android.nostr.NostrSubscriptionManager
import com.skein.android.nostr.PoWPreferenceManager
import com.skein.android.nostr.GeohashAliasRegistry
import com.skein.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.skein.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.skein.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.skein.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.skein.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.skein.android.model.SkeinMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.skein.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.skein.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.skein.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.skein.android.model.SkeinMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.skein.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.skein.android.geohash.ChannelID.Mesh -> {
            ...
            is com.skein.android.geohash.ChannelID.Location -> {
