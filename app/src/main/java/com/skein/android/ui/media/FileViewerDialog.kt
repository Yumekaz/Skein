...
import com.skein.android.features.file.FileUtils
 ...
 */
private fun tryOpenFile(context: Context, packet: SkeinFilePacket) {
    try {
        // First try to save to temp file and open
        val tempFile = File.createTempFile("skein_", ".${packet.fileName.substringAfterLast(".")}", context.cacheDir)
