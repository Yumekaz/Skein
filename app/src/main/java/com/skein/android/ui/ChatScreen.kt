...
import com.skein.android.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    var selectedMessageForSheet by remember { mutableStateOf<SkeinMessage?>(null) }
    ...
    val displayMessages = when {
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.skein.android.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.skein.android.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.skein.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.skein.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.skein.android.R.string.cd_scroll_to_bottom),
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.skein.android.geohash.LocationChannelManager.getInstance(context) }
...
private fun ChatDialogs(
    ...
    selectedMessageForSheet: SkeinMessage?,
    viewModel: ChatViewModel,
    ...
    if (showDebugSheet) {
        com.skein.android.ui.debug.DebugSettingsSheet(
