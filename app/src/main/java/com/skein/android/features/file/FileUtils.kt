package com.skein.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.skein.android.model.SkeinFilePacket
    ): String {
    ...
    /**
     * Classify SkeinMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.skein.android.model.SkeinMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.skein.android.model.SkeinMessageType.Image
            lower.startsWith("audio/") -> com.skein.android.model.SkeinMessageType.Audio
            else -> com.skein.android.model.SkeinMessageType.File
        }
    }
