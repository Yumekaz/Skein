...
class MessageHandler(private val myPeerID: String, private val appContext: android.content.Context) {
    ...
    suspend fun handleNoiseEncrypted(routed: RoutedPacket) {
        ...
        try {
            ...
            val noisePayload = com.skein.android.model.NoisePayload.decode(decryptedData)
            ...
            when (noisePayload.type) {
                com.skein.android.model.NoisePayloadType.PRIVATE_MESSAGE -> {
                    ...
                    if (privateMessage != null) {
                        ...
                        // Create SkeinMessage - preserve source packet timestamp
                ...
                com.skein.android.model.NoisePayloadType.FILE_TRANSFER -> {
                    // Handle encrypted file transfer; generate unique message ID
                    val file = com.skein.android.model.SkeinFilePacket.decode(noisePayload.data)
                    if (file != null) {
                        Log.d(TAG, "🔓 Decrypted encrypted file from $peerID: name='${file.fileName}', size=${file.fileSize}, mime='${file.mimeType}'")
                        val uniqueMsgId = java.util.UUID.randomUUID().toString().uppercase()
                        val savedPath = com.skein.android.features.file.FileUtils.saveIncomingFile(appContext, file)
                        val message = SkeinMessage(
                            id = uniqueMsgId,
                            sender = delegate?.getPeerNickname(peerID) ?: "Unknown",
                            content = savedPath,
                            type = com.skein.android.features.file.FileUtils.messageTypeForMime(file.mimeType),
                            timestamp = java.util.Date(packet.timestamp.toLong()),
                            isRelay = false,
                            isPrivate = true,
                            recipientNickname = delegate?.getMyNickname(),
                ...
                com.skein.android.model.NoisePayloadType.DELIVERED -> {
                ...
                com.skein.android.model.NoisePayloadType.READ_RECEIPT -> {
                ...
                com.skein.android.model.NoisePayloadType.VERIFY_CHALLENGE -> {
                ...
                com.skein.android.model.NoisePayloadType.VERIFY_RESPONSE -> {
    ...
    private suspend fun sendDeliveryAck(messageID: String, senderPeerID: String) {
        try {
            ...
            val ackPayload = com.skein.android.model.NoisePayload(
                type = com.skein.android.model.NoisePayloadType.DELIVERED,
    ...
    suspend fun handleAnnounce(routed: RoutedPacket): Boolean {
        ...
        if (clockSkewMs > ANNOUNCE_CLOCK_SKEW_TOLERANCE_MS) {
            ...
            return false
        } else if (clockSkewMs > com.skein.android.util.AppConstants.Mesh.STALE_PEER_TIMEOUT_MS) {
        ...
        try {
            val neighborsOrNull = com.skein.android.services.meshgraph.GossipTLV.decodeNeighborsFromAnnouncementPayload(packet.payload)
        ...
        try {
            ...
            if (response != null) {
                ...
                val responsePacket = SkeinPacket(
                    ...
                    payload = response,
                    signature = null,
                    ttl = com.skein.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS
                )
    ...
    private suspend fun handleBroadcastMessage(routed: RoutedPacket) {
        ...
        try {
            ...
            val isFileTransfer = com.skein.android.protocol.MessageType.fromValue(packet.type) == com.skein.android.protocol.MessageType.FILE_TRANSFER
            val file = com.skein.android.model.SkeinFilePacket.decode(packet.payload)
            if (file != null) {
                if (isFileTransfer) {
     ...
     */
    private suspend fun handlePrivateMessage(packet: SkeinPacket, peerID: String) {
        try {
    ...
    private fun handleFavoriteNotificationFromMesh(content: String, fromPeerID: String) {
        try {
            ...
            if (noiseKey != null) {
                com.skein.android.favorites.FavoritesPersistenceService.shared.updatePeerFavoritedUs(noiseKey, isFavorite)
                if (npub != null) {
                    // Index by noise key and current mesh peerID for fast Nostr routing
                    com.skein.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKey(noiseKey, npub)
                    com.skein.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKeyForPeerID(fromPeerID, npub)
                }
                ...
                val sys = com.skein.android.model.SkeinMessage(
                    sender = "system",
...
interface MessageHandlerDelegate {
    ...
    // Packet operations
    fun sendPacket(packet: SkeinPacket)
    fun relayPacket(routed: RoutedPacket)
    fun getBroadcastRecipient(): ByteArray
    
    // Cryptographic operations
    fun verifySignature(packet: SkeinPacket, peerID: String): Boolean
    ...
    // Callbacks
    fun onMessageReceived(message: SkeinMessage)
