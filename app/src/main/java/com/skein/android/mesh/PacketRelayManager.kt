 ...
 * 
 * This class handles all relay decisions and logic for Skein packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.skein.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: SkeinPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: SkeinPacket, fromPeerID: String): Boolean {
