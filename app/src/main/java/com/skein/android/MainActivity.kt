...
import com.skein.android.onboarding.BluetoothCheckScreen
import com.skein.android.onboarding.BluetoothStatus
import com.skein.android.onboarding.BluetoothStatusManager
import com.skein.android.onboarding.BatteryOptimizationManager
import com.skein.android.onboarding.BatteryOptimizationPreferenceManager
import com.skein.android.onboarding.BatteryOptimizationScreen
import com.skein.android.onboarding.BatteryOptimizationStatus
import com.skein.android.onboarding.BackgroundLocationPermissionScreen
import com.skein.android.onboarding.InitializationErrorScreen
import com.skein.android.onboarding.InitializingScreen
import com.skein.android.onboarding.LocationCheckScreen
import com.skein.android.onboarding.LocationStatus
import com.skein.android.onboarding.LocationStatusManager
import com.skein.android.onboarding.OnboardingCoordinator
import com.skein.android.onboarding.OnboardingState
import com.skein.android.onboarding.PermissionExplanationScreen
import com.skein.android.onboarding.PermissionManager
import com.skein.android.ui.ChatScreen
import com.skein.android.ui.ChatViewModel
import com.skein.android.ui.OrientationAwareActivity
import com.skein.android.ui.theme.SkeinTheme
import com.skein.android.wifiaware.WifiAwareController
import com.skein.android.nostr.PoWPreferenceManager
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.skein.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.skein.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.skein.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.skein.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        meshService = com.skein.android.service.MeshServiceHolder.getOrCreate(applicationContext)
        unifiedMeshService = com.skein.android.service.MeshServiceHolder.getUnifiedOrCreate(applicationContext)
    ...
    private fun checkBluetoothAndProceed() {
        ...
        val bleRequired = try { com.skein.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        if (!bleRequired) {
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.skein.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun handleLocationEnabled() {
        ...
        com.skein.android.wifiaware.WifiAwareController.startIfPossible()
        checkBatteryOptimizationAndProceed()
    }
    ...
    private fun handleOnboardingComplete() {
        ...
        val bleRequired2 = try { com.skein.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        when {
    ...
    private fun startMeshForegroundServiceBestEffort() {
        ...
        try {
            com.skein.android.service.MeshForegroundService.start(applicationContext)
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.skein.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.skein.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.skein.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.skein.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.skein.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.skein.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.skein.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.skein.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.skein.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.skein.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.skein.android.geohash.GeohashChannelLevel.REGION
                        else -> com.skein.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.skein.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.skein.android.geohash.ChannelID.Location(geohashChannel)
    ...
    private fun handleVerificationIntent(intent: Intent) {
        ...
        if (uri.scheme != "skein" || uri.host != "verify") return
