...
@Parcelize
enum class SkeinMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * SkeinMessage - 100% compatible with iOS version
 */
@Parcelize
data class SkeinMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: SkeinMessageType = SkeinMessageType.Message,
    val timestamp: Date,
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): SkeinMessage? {
            try {
