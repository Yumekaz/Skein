...
/**
 * Skein-over-Nostr Adapter
 * Direct port from iOS implementation for 100% compatibility
 */
object NostrEmbeddedSkein {
    
    private const val TAG = "NostrEmbeddedSkein"
    
    /**
     * Build a `bitchat1:` base64url-encoded Skein packet carrying a private message for Nostr DMs.
     */
    ...
    /**
     * Build a `bitchat1:` base64url-encoded Skein packet carrying a delivery/read ack for Nostr DMs.
     */
