...
class BinaryProtocolTest {
    ...
    @Test
    fun `SkeinPacket toBinaryData propagates padding flag`() {
     ...
     * anything it can't parse as a valid SkeinPacket.
     */
    @Test
    ...
    private fun roundTrip(packet: SkeinPacket): SkeinPacket {
    ...
    private fun assertPacketEquals(expected: SkeinPacket, actual: SkeinPacket) {
